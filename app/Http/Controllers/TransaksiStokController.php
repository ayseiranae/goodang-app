...
class TransaksiStokController extends Controller
{
    public function index(Request $request)
    {
        ...
        // Kalau request AJAX (live search), kirim partial table saja
        if ($request->ajax()) {
            return view('transaksi.table_body', compact('transaksi'))->render();
        }

        // Untuk tampilan awal (non-AJAX) kita juga butuh data barang & pemasok buat modal
    ...
    {
        // Validasi manual supaya gampang balikin JSON error
        ...
        // Wajib isi pemasok kalau transaksi MASUK
